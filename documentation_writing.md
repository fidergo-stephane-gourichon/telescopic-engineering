...
- all sections very concise (few sentences)
...
- dependencies,
- "more" with an ordered list of other documents in the project (including all links that were in previous sections)

The README.md may have some sections in another order, or even missing entirely, if that serves clarity.
